...
select
  c.id,
  'filmmaker_materials_submitted',
  'filmmaker_materials_form',
  f.id::text,
  f.created_at,
  'filmmaker-materials:' || f.id::text,
...
select
  c.id,
  'ticket_giveaway_entered',
  'ticket_giveaway',
  g.id::text,
  g.created_at,
  'ticket-giveaway:' || g.id::text,
